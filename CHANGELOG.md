...
- [#106](https://github.com/sanity-io/use-effect-event/pull/106) [`7241104`](https://github.com/sanity-io/use-effect-event/commit/72411046148013aa8f31528aca8af733625e7b79) Thanks [@stipsan](https://github.com/stipsan)! - The function returned by `useEffectEvent` now has a stable identity: the same function is returned on every render, and it always calls the latest version of the callback. Previously a new function was created on every render, matching the native hook.
